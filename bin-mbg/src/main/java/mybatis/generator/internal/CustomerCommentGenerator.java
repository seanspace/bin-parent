package mybatis.generator.internal;
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        xmlElement
                .addElement(new TextElement(
                        "  当前类是由MBG插件自动生成, 请勿修改.")); //$NON-NLS-1$

        String s = getDateString();
        if (s != null) {
            sb.setLength(0);
            sb.append("  生成时间: "); //$NON-NLS-1$
            sb.append(s);
            sb.append('.');
            xmlElement.addElement(new TextElement(sb.toString()));
        }
...
//        sb.append(MergeConstants.NEW_ELEMENT_TAG);
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass
                .addJavaDocLine(" * 本类由MBG插件生成."); //$NON-NLS-1$

        sb.append(" * 本类对应数据库表名 "); //$NON-NLS-1$
    ...
    public void addEnumComment(InnerEnum innerEnum,
        ...
        innerEnum
                .addJavaDocLine(" * 本枚举类由MBG插件生成."); //$NON-NLS-1$
    ...
    public void addFieldComment(Field field,
        ...
        field
                .addJavaDocLine(" * 该属性由MBG插件生成."); //$NON-NLS-1$

        sb.append(" * 该属性对应数据库表 "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append("的列");
